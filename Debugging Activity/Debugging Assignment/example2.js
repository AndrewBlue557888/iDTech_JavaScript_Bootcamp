...
function checkPoint2(){
    ...
    const studentID = [];
     /* can be constant, despite being altered. (after looking it up, 
        turns out you simply can't reasign the variable, even to another array,
        but the actual array and elements can still be altered.) */

    for (var i = 0; i < friends.length; i++){
         // changed "const i = 1;" to "var i = 0;"
